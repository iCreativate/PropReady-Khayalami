...
export const DEMO_BUYER_LEADS = [
    {
        ...
        email: 'thabo.demo@prop-ready.co.za',
        phone: '+27821234001',
        city: 'Johannesburg',
        employmentStatus: 'Permanent employment',
        monthlyIncome: 'R45,000',
        depositSaved: 'R180,000',
        creditScore: 'Good',
        score: 88,
        preQualAmount: 1850000,
        bondOriginator: 'sa-home-loans',
...
export const DEMO_SELLER_LEADS = [
    {
        id: 'demo-seller-patricia',
        leadType: 'seller' as const,
        fullName: 'Patricia Khumalo',
        email: 'patricia.demo@prop-ready.co.za',
        phone: '+27851234004',
        city: 'Midrand',
...
export const DEMO_VIEWINGS = [
    ...
    },
    {
        ...
        sellerLeadId: 'demo-seller-patricia',
        buyerName: 'Lerato Naidoo',
        buyerEmail: 'lerato.demo@prop-ready.co.za',
        buyerPhone: '+27831234002',
        sellerName: 'Patricia Khumalo',
        sellerEmail: 'patricia.demo@prop-ready.co.za',
        sellerPhone: '+27851234004',
