                ...
                <div className="container mx-auto max-w-4xl relative z-10">
                    <div className="premium-card rounded-2xl p-8 md:p-12 shadow-2xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold text-charcoal">POPI Act</h1>
                                <p className="text-charcoal/70 text-sm mt-1">Protection of Personal Information Act (South Africa)</p>
                            </div>
                        </div>
                        ...
                        <div className="prose prose-charcoal max-w-none space-y-8">
                            <section className="premium-card rounded-xl p-6 bg-gradient-to-br from-gold/5 to-gold/10 border border-gold/20">
                                <h2 className="text-xl font-bold text-charcoal mb-2">Our Commitment</h2>
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-charcoal mb-4">1. What is the POPI Act?</h2>
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-charcoal mb-4">2. How We Comply</h2>
                                <p className="text-charcoal/80 leading-relaxed mb-4">
                            ...
                            <section>
                                ...
                                <p className="text-charcoal/80 leading-relaxed mt-4">
                                    To exercise these rights, contact us at <a href="mailto:info@propready.co.za" className="text-gold hover:text-gold-600">info@propready.co.za</a>.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-charcoal/80 leading-relaxed mb-4">
                                    For any questions about our POPI Act compliance or your personal information:
                                </p>
