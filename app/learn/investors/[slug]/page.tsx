                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <div className="p-3 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label htmlFor="tax-bond-interest" className="form-label !font-semibold !text-charcoal">Bond Interest (not capital)</label>
                                    <input id="tax-bond-interest" name="bondInterest" type="text" placeholder="R 0" className="form-control w-full px-3 py-2 border border-charcoal/20 rounded-lg" />
                                </div>
                                <div className="p-3 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label htmlFor="tax-rates-taxes" className="form-label !font-semibold !text-charcoal">Rates & Taxes</label>
                                    <input id="tax-rates-taxes" name="ratesTaxes" type="text" placeholder="R 0" className="form-control w-full px-3 py-2 border border-charcoal/20 rounded-lg" />
                                </div>
                                <div className="p-3 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label htmlFor="tax-maintenance" className="form-label !font-semibold !text-charcoal">Maintenance & Repairs</label>
                                    <input id="tax-maintenance" name="maintenance" type="text" placeholder="R 0" className="form-control w-full px-3 py-2 border border-charcoal/20 rounded-lg" />
                                </div>
                            ...
                            <div className="space-y-3">
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-property-inspection" name="propertyInspection" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Property inspection completed</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-comparable-sales" name="comparableSales" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Comparable sales researched (CMA)</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-area-growth" name="areaGrowth" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Area growth trends analyzed</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-location-factors" name="locationFactors" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Location factors verified (safety, amenities, infrastructure)</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-rental-rates" name="rentalRates" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Rental rates verified in area</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-property-history" name="propertyHistory" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Property history checked (no hidden issues)</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-objective-criteria" name="objectiveCriteria" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                    ...
                    content: (
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-application-form" name="applicationForm" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Application form completed with all details</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-credit-check" name="creditCheck" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Credit check completed</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-employment" name="employment" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Employment verified (payslips, bank statements)</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-income-ratio" name="incomeRatio" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Income is at least 3x monthly rental</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-references" name="references" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">2+ previous landlord references checked</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-identity" name="identity" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
                                        <span className="text-sm font-semibold text-charcoal">Identity verified (ID copy)</span>
                                    </label>
                                </div>
                                <div className="p-4 bg-charcoal/5 rounded-lg border border-charcoal/10">
                                    <label className="flex items-center space-x-3 cursor-pointer">
                                        <input id="check-lease-agreement" name="leaseAgreement" type="checkbox" className="form-checkbox w-5 h-5 text-gold rounded" />
