...
export default function BondCalculatorPage() {
    ...
    const calculatorPublicHeader = (
        <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-charcoal/10">
            <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
                ...
                <Link
                    href="/"
                    className="hidden sm:block px-4 py-2 rounded-lg border border-charcoal/20 text-charcoal hover:bg-charcoal/5 transition-all"
                >
                    Back to Home
                </Link>
            </nav>
    ...
    return (
        <BuyerPortalShell activePage="calculator" title="Bond Calculator" publicChrome={calculatorPublicHeader}>
