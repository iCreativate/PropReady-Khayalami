...
export default function AdminShell({
    ...
    return (
        <div className="min-h-dvh bg-[#f4f4f5] text-charcoal">
            <div className="flex min-h-dvh">
                <aside className="hidden lg:flex w-64 flex-col bg-charcoal text-white border-r border-white/[0.06]">
                ...
                <div className="flex-1 min-w-0 flex flex-col">
                    <header className="sticky top-0 z-20 bg-white/95 backdrop-blur border-b border-charcoal/[0.07] px-4 sm:px-6 h-14 flex items-center justify-between gap-3">
                    ...
                    <div className="lg:hidden border-b border-charcoal/[0.07] bg-white px-3 py-2 flex gap-1 overflow-x-auto">
